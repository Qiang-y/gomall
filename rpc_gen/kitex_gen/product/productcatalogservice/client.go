...
func (p *kProductCatalogServiceClient) ReduceProduct(ctx context.Context, Req *product.ReduceProductReq, callOptions ...callopt.Option) (r *product.ReduceProductResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ReduceProduct(ctx, Req)
}
